...
NUM_PEOPLE = 1000
SIM_HOURS = 5000
MAX_SYMPTOMATIC_INFECTION_TIME = (24*21)
MAX_ASYMPTOMATIC_INFECTION_TIME = (24*7)
MAX_INCUBATION_TIME = (24*7)

NORMAL_INFECTTION_PROBABILTY = 0.8
MASKED_INFECTTION_PROBABILTY = 0.4
VACCINEATED_INFECTTION_PROBABILTY = 0.4
MASKED_VACCINEATED_INFECTTION_PROBABILTY = 0.2
